          ...
          success: function(data) {
              ...
              if ((data.errors)) {
                  ...
                  if (!data) {
                      ...
                      toastr.success('Successfully added Consumer!', 'Success Alert', {timeOut: 5000});
          ...
          $.ajax({
              ...
              success: function(data) {
                  ...
                  if ((data.errors)) {
                      ...
                      toastr.success('Successfully updated Consumer Data!', 'Success Alert', {timeOut: 5000});
...
$('.modal-footer').on('click', '.delete', function() {
  ...
  $.ajax({
      ...
      success: function(data) {
          toastr.success('Successfully deleted Consumer!', 'Success Alert', {timeOut: 5000});
          $('.item' + id).remove();
          $('.col1').each(function (index) {
              $(this).html(index+1);
          });
