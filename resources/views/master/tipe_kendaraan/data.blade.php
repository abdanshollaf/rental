...
<li class="nav-item">
  <a class="nav-link active">
    <h5>Master Data / Master Tipe Kendaraan</h5>
  </a>
</li>
@endsection
@section('sidebar')
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr class="item{{$item->id}}">
                  ...
                  <td>
                    <button class="btn btn-warning btn-sm edit-modal" data-id="{{$item->id}}" data-nama="{{$item->nama_tipe}}">Edit</button>
                    <button class="btn btn-danger btn-sm delete-modal" data-id="{{$item->id}}" data-nama="{{$item->nama_tipe}}">Delete</button>
                  </td>
                </tr>
                @endforeach
              </tbody>
