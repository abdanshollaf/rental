...
<li class="nav-item">
  <a class="nav-link active">
    <h5>Master Data / Master Driver</h5>
  </a>
</li>
@endsection
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            ...
            <button class="btn btn-primary pull-right add-modal"> <span class="fa fa-plus-circle"></span>
              Tambah</button>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
                ...
                <tr class="item{{$item->id}}">
                  ...
                  <td>
                    <button class="btn btn-warning btn-sm edit-modal" data-id="{{$item->id}}"
                      data-nama="{{$item->nama}}" data-no_telp="{{$item->no_telp}}" data-no_ktp="{{$item->no_ktp}}"
                      data-sim="{{$item->sim}}">Edit</button>
                    <button class="btn btn-danger btn-sm delete-modal" data-id="{{$item->id}}"
                      data-nama="{{$item->nama}}" data-no_telp="{{$item->no_telp}}" data-no_ktp="{{$item->no_ktp}}"
                      data-sim="{{$item->sim}}">Delete</button>
                  </td>
                </tr>
                @endforeach
              </tbody>
