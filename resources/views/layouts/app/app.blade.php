...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a class="brand-link text-white">
      <img src="{{asset('assets/dist/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Admin Panel Rental</span>
    </a>    
    @yield('sidebar')
  </aside>
  @yield('content')
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2019. PT. Kaizen Trans Indonesia. 
    All rights reserved.
  </footer>
...
<script type="text/javascript" src="{{ asset('assets/dist/js/dataTables.bootstrap4.min.js') }}"></script>
{{-- <script type="text/javascript" src="{{ asset('assets/dist/js/jquery-3.3.1.js') }}"></script> --}}
</body>
</html>
