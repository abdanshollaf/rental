...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2019. Kaizen Trans Indonesia.
                All rights reserved.
        </footer>
    ...
    {{-- Data Table --}}
    <script type="text/javascript" src="{{ asset('assets/dist/js/jquery.dataTables.min.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('assets/dist/js/dataTables.bootstrap4.min.js') }}"></script>
    {{-- <script type="text/javascript" src="{{ asset('assets/dist/js/jquery-3.3.1.js') }}">
    </script> --}}
</body>
