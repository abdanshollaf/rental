                        ...
                        <form role="form" action="{{route('orderstore')}}" method="POST">
                          ...
                          <div class="card-body">
                            <div class="row increment form-group">
                                  ...
                                  <div class="form-group col-sm-9">
                                    ...
                                    <div class="form-group col-sm-3">
                                              ...
                                              <input type="text" class="form-control" id="pic" name="detail[0][pic]" placeholder="Enter Passenger Name" required>      
                                    </div>
                                    <div class="form-group col-sm-3">
                                              <label for="alamat">No. Hp Penumpang</label>
                                              <input type="text" class="form-control" id="pic" name="detail[0][hp_pic]" placeholder="Enter Passenger Contact" required>      
                                    </div>
                                    <div class="form-group col-sm-3">
                                                ...
                                                <select name="detail[0][mobil]" id="mobil" class="form-control">
                                                    ...
                                                    @foreach ($mobil as $item)
                                                      <option value="{{$item->id}}">{{$item->vendor}} {{$item->no_polisi}} - {{$item->merk}} {{$item->tipe}}</option>
                                                    @endforeach
                                                </select>
                                  </div>
                                  <div class="form-group col-sm-3">
                                  ...
                                  <div class="form-group col-sm-3">
                                            ...
                                            <input type="text" class="form-control" id="jemput" name="detail[0][jemput]" placeholder="Enter Departure Address">
                                  </div>
                                  <div class="form-group col-sm-3">
                                            <label for="tujuan">Tujuan</label>
                                            <input type="text" class="form-control" id="tujuan" name="detail[0][tujuan]" placeholder="Enter Arrival Address">
                                  </div>
                                  ...
                                  <div class="form-group col-sm-3">
                                            ...
                                            <input type="number" class="form-control" id="harga" name="detail[0][harga]" placeholder="Enter Price" required>
                                  </div>
                            </div>
                            ...
                            <div class="form-group col-sm-2">
                                ...
                                <input type="number" value="0" class="form-control" id="dibayar" name="dibayar" placeholder="Enter Price">
                            </div>
                          <!-- /.card-body -->
                          <div class="container">
