                        ...
                        <div class="card-body">
                            <div class="row form-group">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="input-group date" data-target-input="nearest">
                                        <input type="text" id="start_date0" name="detail[0][start_date]" onchange="onChange(0)"
                                        ...
                                        <input type="text" id="end_date0" name="detail[0][end_date]" 
...
<script type="text/javascript">
        ...
        $(function () {
            ...
            $('#start_date0').datetimepicker({
                format: 'YYYY-MM-DD'
            });
            $('#end_date0').datetimepicker({
                format: 'YYYY-MM-DD'
            });
    ...
    //Saatnya bikin event onchange 
    function onChange(index){
        var startDate = $('#start_date'+index).value;
        var endDate = $('#end_date'+index).value;
        $.get('{{url('orders')}}?startDate='+startDate+'&endDate='+endDate,function(data){
            console.log(data);
